...
INSERT INTO `links` (`link_id`, `url`, `rating`, `reports`, `topic_id`) VALUES
(1, 'http://difur.in.ua/studentam/lektsii/lc03/', NULL, NULL, 1),
(2, 'https://yukhym.com/uk/prikladi-diferentsialnikh-rivnyan/neodnoridni-diferentsialni-rivnyannya-2-poryadku.html', NULL, NULL, 2),
(3, 'https://uk.wikipedia.org/wiki/%D0%A0%D1%8F%D0%B4_(%D0%BC%D0%B0%D1%82%D0%B5%D0%BC%D0%B0%D1%82%D0%B8%D0%BA%D0%B0)', NULL, NULL, 3),
(4, 'https://en.wikipedia.org/wiki/Multiple_integral', NULL, NULL, 4),
(5, 'https://en.wikipedia.org/wiki/Probability_theory#Discrete_probability_distributions', NULL, NULL, 5),
(6, 'https://www.bincodes.com/bin-search/', NULL, NULL, 6);
...
--
ALTER TABLE `ssubject`
  MODIFY `sSubject_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
